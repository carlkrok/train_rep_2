...
# USE CAMERA ANGE [left, right, center], LAP [LEFT, RIGHT]
    ...
    for i_elem in range(data_size):
        ...
        image = cv2.imread(data_files[camera_angle][i_elem].strip())#misc.imread(data_files[camera_angle][i_elem].strip())
        ...
        if image is not None:
            ...
            image = cv2.resize(image,(64,64), interpolation=cv2.INTER_AREA)#np.resize(image, (64, 64, 3))
